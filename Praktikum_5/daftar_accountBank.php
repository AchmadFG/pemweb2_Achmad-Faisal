    ...
    <div class="container" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);">
        <table class="example display nowrap table-striped table-bordered table" style="width:100%">
            ...
            <tbody>
                ...
                $abdul = new BankAccount("C001", 6000000, "Abdul");
                $adit = new BankAccount("C002", 5350000, "Adit");
                $yanto = new BankAccount("C003", 2500000, "Yanto");
                $totalAccount = array(1 => $abdul, $adit, $yanto);
        ...
        <hr>
        <p>Abdul nabung 1.000.000</br>
            Abdul transfer 1.500.000 ke Adit dan 500.000 ke Yanto</br>
            Adit tarik uang 2.500.000</p>
        <table class="example display nowrap table-striped table-bordered table" style="width:100%">
            <thead>
                <tr>
                    <th>No</th>
            ...
            <tbody>
                <?php
                $abdul->deposit(1000000);
                $abdul->transfer($adit, 1500000);
                $abdul->transfer($yanto, 500000);
                $adit->withdraw(2500000);
                $totalAccount = array(1 => $abdul, $adit, $yanto);
                foreach ($totalAccount as $no => $value) {
                    echo "<tr>";
                    echo "<td>" . $no . "</td>";
